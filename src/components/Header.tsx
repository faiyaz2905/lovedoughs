...
import { CookieLogo } from "./Doodles";
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-12">
        ...
        <Link to="/" className="mx-6 flex shrink-0 items-center gap-2">
          <CookieLogo className="h-12 w-12" />
          <span className="font-display text-2xl font-bold tracking-tight text-chocolate">
            Love Doughs
          </span>
        </Link>
