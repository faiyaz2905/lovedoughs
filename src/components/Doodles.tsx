...
export function HappyCookieDoodle({ className = "" }: { className?: string }) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full text-chocolate" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M 50,12 C 72,12 88,28 88,50 C 88,58 84,62 82,66 C 78,74 80,78 78,82 C 72,88 64,88 50,88 C 28,88 12,72 12,50 C 12,28 28,12 50,12 Z" fill="#FED2C7" />
        <path d="M 78,24 C 74,28 74,34 78,38 C 82,42 88,42 92,38" stroke="currentColor" strokeWidth="2.5" fill="none" />
  ...
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full text-chocolate" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M 28,30 L 72,30 L 68,76 C 68,82 60,86 50,86 C 40,86 32,82 32,76 Z" fill="#E8F4E5" />
...
export function HappyStarDoodle({ className = "" }: { className?: string }) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full text-chocolate" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M 50,10 L 62,38 L 92,38 L 68,56 L 78,86 L 50,68 L 22,86 L 32,56 L 8,38 L 38,38 Z" fill="#FFF4D0" />
...
export function SpeechBubbleDoodle({ className = "", text = "yum!" }: { className?: string; text?: string }) {
  return (
    <motion.div
      className={`inline-block ${className}`}
    ...
    >
      <svg viewBox="0 0 120 70" className="w-full h-full text-chocolate" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M 10,30 C 10,14 28,10 60,10 C 92,10 110,14 110,30 C 110,46 92,50 60,50 C 48,50 36,54 26,62 C 28,52 10,46 10,30 Z" fill="white" />
        <text x="60" y="36" textAnchor="middle" dominantBaseline="middle" fill="currentColor" className="font-display font-bold text-sm select-none italic" stroke="none">
          {text}
        </text>
      </svg>
    </motion.div>
